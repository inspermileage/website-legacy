                    ...
                    <div class="has-horizontal-scroll has-text-centered">
                        <div class="scrolling-wrapper-flexbox">
                            <div class="departaments">
                                ...
                                <h6 class="is-size-5">
                                    Área responsável por estabelecer o meio de
                                    comunicação dos dados com o piloto, para que
                                    possa auxiliá-lo na pista. Ademais, também
                                    mantenedor deste site.{" "}
                                </h6>
                            </div>
                            ...
                            <div class="departaments">
                                ...
                                <h6 class="is-size-5">
                                    A área de controle é responsável por fazer
                                    isso aquilo e mais isso.
                                </h6>
                            </div>
                    ...
                    <div class="has-horizontal-scroll has-text-centered">
                        <div class="scrolling-wrapper-flexbox">
                            <div class="departaments">
                                ...
                                <h6 class="is-size-5">
                                    A área de mecânica é responsável pelo chassi
                                    do carro e blabla.
                                </h6>
                            </div>
                            ...
                            <div class="departaments">
                                ...
                                <h6 class="is-size-5">
                                    A área de eletrônica é responsável por fazer
                                    isso aquilo e mais isso.
                                </h6>
                            </div>
                            <div class="padder-card" />
